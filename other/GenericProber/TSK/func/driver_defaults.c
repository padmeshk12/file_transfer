...
)
{
    ...
    {
	{ PHPFUNC_MOD_TSK_APM, "APM90A" },
	{ PHPFUNC_MOD_TSK_APM, "APM88" },
	{ PHPFUNC_MOD_TSK_APM, "APM89" },

	{ PHPFUNC_MOD_TSK_UF, "UF190" },
	{ PHPFUNC_MOD_TSK_UF, "UF200" },
	{ PHPFUNC_MOD_TSK_UF, "UF300" },
    { PHPFUNC_MOD_TSK_UF, "UF3000" },
