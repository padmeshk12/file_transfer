 ...
 * plugin function phPFuncGetStart(3) (see ph_pfunc.h). The purpose of
 ...
 * states has been modified in the state controller and PHPFUNC_ERR_OK
 * is returned in <funcError>, PHEVENT_RES_HANDLED
 *
 * TIMEOUT - The operator wants to simulate a timeout error ->
 * PHPFUNC_ERR_TIMEOUT is returned in <funcError>,
 * PHEVENT_RES_CONTINUE
 * 
 * Returns: error code
 *
 ...
 * 
 * In hand test mode, this function is called instead of the driver
 * plugin function phPFuncBinDevice(3) (see ph_pfunc.h). The purpose 
 ...
 * 
 * This function will behave exactly the same as phPFuncBinDevice(3)
 * in terms of postconditions:
 *
 * QUIT - The testprogram will be stopped (double confirmation) -> Set
 * quit flag, PHEVENT_RES_ABORT, PHTCOM_CI_CALL_PASS
 *
 * CONTINUE - Set populated sites to empty. PHPFUNC_ERR_OK must
 ...
 *
 * In hand test mode, this function is called instead of the driver
 * plugin function phPFuncReprobe(3) (see ph_pfunc.h). The purpose of
 * this function is to ask the operator to play the role of the
 ...
 * PHPFUNC_ERR_OK must be returned in <funcError>, PHEVENT_RES_HANDLED
 *
 * Returns: error code
 *
 *****************************************************************************/
