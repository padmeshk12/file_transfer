...
begin
  ...
  testbed_path = xoc_workspace + "/ph-development/phcontrol/drivers/Generic_93K_Driver/GenericProber/test/testbed"
  scripts_path = xoc_workspace + "/ph-development/phcontrol/drivers/Generic_93K_Driver/GenericProber/test/scripts"
  
  tc_client_wafer = testbed_path + "/tc_client_wafer/tc_client_wafer" 
