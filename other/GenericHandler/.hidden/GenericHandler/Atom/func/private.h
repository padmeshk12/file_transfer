...
#define EXECGPIBCMD_IMPLEMENTED
#define EXECGPIBQUERY_IMPLEMENTED
...
struct pluginPrivate {
        ...
        // the new variable using for delay between BIN command and RFT command, unit is microsecond
        long          pollingDelay;
	u_int          timeAskLotEnd;
	// variable used for receiving waiting_for_lot_timeout
        u_int            lotTimeOutInteger;
	char           gpibEndOfLine[16];
