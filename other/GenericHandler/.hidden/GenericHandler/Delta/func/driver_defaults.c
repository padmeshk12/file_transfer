...
)
{
    ...
    {
	{ PHFUNC_MOD_CASTLE_LX, "Castle" },
	{ PHFUNC_MOD_MATRIX, "Matrix" },
	{ PHFUNC_MOD_SUMMIT, "Summit" },
	{ PHFUNC_MOD_FLEX, "Flex" },
	{ PHFUNC_MOD_RFS, "RFS" },
	{ PHFUNC_MOD_ORION, "Orion"},
	{ PHFUNC_MOD_ECLIPSE, "Eclipse"},
