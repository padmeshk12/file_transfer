 ...
 *            14 Oct 2004, Ken Ward, added Delta Orion commands
...
#define STRIPINDEXID_IMPLEMENTED  /* Orion only */
#define STRIPMATERIALID_IMPLEMENTED  /* Orion only */
...
struct pluginPrivate {
    ...
    int             binningCommandFormat;  /* value could be 16 and 256 */
    ...
    int             summitReprobeBug;
    int             summitNoStopStart;
    int             summitNoVerify;

    int             rfsUseTestresults;
...
/* Start kaw add Oct 24 2004 */

#ifdef STRIPINDEXID_IMPLEMENTED
/*****************************************************************************
 *
 * return the handler strip identification string
 *
 * Authors: Ken Ward
 *
 * Description:
...
/*****************************************************************************
 *
 * return the handler material identification string
 *
 * Authors: Ken Ward
 *
 * Description:
 ...
 *  the token is the command, and param is its parameter.
 *
 ***************************************************************************/
