...
/*--- StatusBit constructor -------------------------------------------------*/

StatusBit::StatusBit() : value(false), position(No_position), name(""), key(0)
{
}

StatusBit::StatusBit(bool v, int p, const char* n) :
    value(v), position(p), name(n), key(0)
{
}

/*--- StatusBit destructor --------------------------------------------------*/
...
/*--- StatusBit public member functions -------------------------------------*/

void StatusBit::setStatusBit(bool v, int p, const char* n)
{
    value=v;
    position=p;
    name=n;
...
const char *StatusBit::getKey() const
{
    if ( !key )
    {
 ...
 *
 *****************************************************************************/
void replaceCharacterInString(char *s, char fc, char rc)
{
    while ( *s )
    {
        if ( *s == fc )
 ...
 *
 *****************************************************************************/
void replaceWhiteSpaceInString(char *s, char rc)
{
...
const char *getTimeString()
{
    ...
    sprintf(theTimeString, "%4d/%02d/%02d %02d:%02d:%02d.%04ld",
