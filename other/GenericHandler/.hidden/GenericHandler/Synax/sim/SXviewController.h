 ...
 *-----------------------------------------------------------------------------
 *
 * MODULE   : SXviewController.h
 * CREATED  : 22 Jan 2001
 *
 * CONTENTS : Interface header for Synax view controller implementation 
 *            class
 *
...
#ifndef _SX_VIEW_CONT_IMPL_H_
#define _SX_VIEW_CONT_IMPL_H_
...
class SXViewController : public ViewController, public SynaxStatusObserver {
public:
  SXViewController(phLogId_t l,
...
protected:
  SXHandlerController *pSXHandlerController;
...
//            break;
//          case SEHandlerController::Yokogawa:
//            title="Yokogawa GPIB Handler HS2000";
//            break;
//        }
//
