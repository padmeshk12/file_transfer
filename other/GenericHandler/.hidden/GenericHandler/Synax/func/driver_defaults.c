                       ...
                       )
{
  ...
  /* this is the list of accepted handler models by this plugin for
     ...
     names. E.g. A Synax family driver may accept the models
     SX1101 and SX1701 */

  static struct modelDef myModels[] =
  {
    { PHFUNC_MOD_SX1101, "SX1101"},
    { PHFUNC_MOD_SX1701, "SX1701"},
    { PHFUNC_MOD_SX2400, "SX2400"},
