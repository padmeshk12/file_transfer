...
//            eCorruptBinDataScheme cbds);
    ...
    void setSitePopulated(int s,bool p);
    unsigned long getSitePopulationAsLong();
   // unsigned long getSitePopulationAsLong_Tesec3270();
    void getSitePopulationAsLong_Tesec3270(char *sitepop);
    ...
    bool readyForRelease();
    void start();
    void setStartFlagFor5170(bool flag);
    bool isStartFor5170();
    void stop();
    bool isStopped();
    bool sendTestStartSignal();
    bool allTestsComplete();
    bool testsNotStarted();
