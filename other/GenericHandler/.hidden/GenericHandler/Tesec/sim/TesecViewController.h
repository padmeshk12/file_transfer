 ...
 *-----------------------------------------------------------------------------
 *
 * MODULE   : esecViewController.h
 * CREATED  : 12 Feb 2002
 *
 * CONTENTS : Interface header for Tesec view controller implementation 
 *            class
 *
...
#ifndef _TESEC_VIEW_CONT_IMPL_H_
#define _TESEC_VIEW_CONT_IMPL_H_
...
class TesecViewController : public ViewController, public TesecStatusObserver
{
public:
    TesecViewController(phLogId_t l,
                        TesecHandlerController *pTHandCont,
                        TesecStatus *pTs,
                        ViewControllerSetup *pVCsetup);
    ~TesecViewController();
    virtual void createView();
    virtual void getGuiData();
    virtual void TStatusChanged(TesecStatus::eTStatus, bool b);
protected:
    TesecHandlerController *pTHandlerController;
    TesecStatus *pTstatus;
};
...
#endif /* ! _TESEC_VIEW_CONT_IMPL_H_ */
