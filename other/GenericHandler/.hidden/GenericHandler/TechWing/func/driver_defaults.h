 ...
 *            12 Dec 2005, Alan Lin & Jiawei Lin, CR29015
 *              Converted to support TechWing handler
 *            20 Aug 2008, Xioafei Han, CR33527
 *              Added model TW3XX
 *
 * Instructions:
 *
...
enum handlerModel {
  ...
  PHFUNC_MOD_TW2XX           /* TW282, etc. */,
  PHFUNC_MOD_TW3XX           /* TW302, etc. */,
