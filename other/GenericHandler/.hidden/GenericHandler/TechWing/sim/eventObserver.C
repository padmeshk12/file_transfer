...
PlaybackErrorException::~PlaybackErrorException()
{
}
...
EventRecorder::EventRecorder(
        ...
        TechWingStatus *pTechWingstatus           /* status object */,
        TechWingStatusObserver* recObs      /* observer object of status */,
    ...
    pHandController(pHC)
{
    ...
    pTechWingstatus->registerRecorder(this,recObs);
}
...
EventPlayback::EventPlayback(
        phLogId_t l                       /* log identifier */,
        TechWingStatus *pTechWings            /* convert status str to enum
...
void EventPlayback::checkEvent(int eventCount)
{
    while ( eventCount >= recordStep && !end )
    {
        ...
        {
            bool eventUsed=pTechWingstatus->setStatusBit(this, recordStatus, recordValue);
...
void EventPlayback::TechWingStatusChanged(TechWingStatus::eTechWingStatus, bool b)
{
}
...
void EventPlayback::getPlaybackComponent()
{
    ...
    if ( rtn_fscanf == 3 )
    {
        ...
        recordStatus=pTechWingstatus->getEnumStatus(strRecordName);
