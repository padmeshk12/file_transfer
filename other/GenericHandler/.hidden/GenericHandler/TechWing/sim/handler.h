...
//            eCorruptBinDataScheme cbds);
    ...
    unsigned long long getSitePopulationAsLong();
    ...
    void stop();
    bool isStopped();
    bool sendLotStartSignal();
    bool sendTestStartSignal();
    bool allTestsComplete();
    void logHandlerStatistics();
    void setSitesEnabled(long long mask);
    long long getSitesEnabled();
    long long getSitesDisabled();
...
protected:
    ...
    bool allSitesBinned();
    bool reprobePending();
    long long getNumberOfSitesAsLong();
