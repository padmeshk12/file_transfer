 ...
 *-----------------------------------------------------------------------------
 *
 * MODULE   : TechWingviewController.h
 * CREATED  : 22 Jan 2001
 *
 * CONTENTS : Interface header for TechWing view controller implementation 
 *            class
 *
...
#ifndef _TECHWING_VIEW_CONT_IMPL_H_
#define _TECHWING_VIEW_CONT_IMPL_H_
...
#endif /* ! _TECHWING_VIEW_CONT_IMPL_H_ */
