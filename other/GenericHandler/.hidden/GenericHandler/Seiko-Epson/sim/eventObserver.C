    ...
    pHandController(pHC)
{
    ...
    pSEstatus->registerRecorder(this,recObs);
}
...
void EventPlayback::checkEvent(int eventCount)
{
    while ( eventCount >= recordStep && !end )
    {
        ...
        {
            bool eventUsed=pSEstatus->setStatusBit(this, recordStatus, recordValue);
...
void EventPlayback::SEStatusChanged(SeikoEpsonStatus::eSEStatus, bool b)
{
}
...
void EventPlayback::getPlaybackComponent()
{
    ...
    if ( rtn_fscanf == 3 )
    {
        ...
        recordStatus=pSEstatus->getEnumStatus(strRecordName);
