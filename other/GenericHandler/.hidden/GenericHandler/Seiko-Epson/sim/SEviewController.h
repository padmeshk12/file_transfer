 ...
 *-----------------------------------------------------------------------------
 *
 * MODULE   : SEviewController.h
 * CREATED  : 22 Jan 2001
 *
 * CONTENTS : Interface header for Seiko-Epson view controller implementation 
 *            class
 *
...
class SEViewController : public ViewController, public SeikoEpsonStatusObserver
{
public:
    SEViewController(phLogId_t l,
...
protected:
    SEHandlerController *pSEHandlerController;
