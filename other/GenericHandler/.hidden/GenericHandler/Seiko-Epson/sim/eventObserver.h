...
public:
    ...
    virtual void printMessage();
    virtual ~PlaybackErrorException(){};
private:
    Std::string message;
};
...
public:
    EventRecorder(
        ...
        SeikoEpsonStatus *pSEstatus           /* status object */,
        SeikoEpsonStatusObserver* recObs      /* observer object of status */,
...
class EventPlayback : public EventObserver, public SeikoEpsonStatusObserver
{
public:
    EventPlayback(
        phLogId_t l                       /* log identifier */,
        SeikoEpsonStatus *pSEs            /* convert status str to enum 
...
private:
    ...
    SeikoEpsonStatus::eSEStatus recordStatus;
