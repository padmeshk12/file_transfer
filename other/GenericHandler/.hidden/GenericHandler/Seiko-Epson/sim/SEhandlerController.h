...
#ifndef _SE_HANDLER_CONT_H_
#define _SE_HANDLER_CONT_H_
...
struct SEHandlerControllerSetup;

class eventRecorder;
class SEViewController;


class SEHandlerController : public HandlerController, public SeikoEpsonStatusObserver
{
public:
    enum eSEModel { NS5000, NS6000, NS7000, HONTECH, NS6040, NS8040, CHROMA };

    SEHandlerController(
        SEHandlerControllerSetup   *setup       /* configurable setup values */,
        ViewControllerSetup      *VCsetup       /* view controller */);
    virtual ~SEHandlerController();
    virtual void switchOn();
    virtual void SEStatusChanged(SeikoEpsonStatus::eSEStatus, bool b);
    eSEModel getModelType() const;
protected:
    ...
    void serviceBarcode(const char *msg);
    void serviceEchoCode(const char *msg);
    ...
    SeikoEpsonStatus *pSEstatus;
    SEViewController *pSEViewController; 
    eSEModel model;
    bool verifyTest;
    bool multipleSrqs;
    int  dl;
...
struct SEHandlerControllerSetup : public HandlerControllerSetup
{
    SEHandlerController::eSEModel model;
    bool verifyTest;
    bool multipleSrqs;
