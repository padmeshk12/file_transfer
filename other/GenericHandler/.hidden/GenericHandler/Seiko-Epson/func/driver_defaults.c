...
)
{
    ...
    static char myFamily[] = "Seiko-Epson";
    ...
    {
	{ PHFUNC_MOD_NS5000, "NS5000" },
	{ PHFUNC_MOD_NS6000, "NS6000" },
	{ PHFUNC_MOD_NS7000, "NS7000" },
        { PHFUNC_MOD_HONTECH, "HONTECH" },
        { PHFUNC_MOD_NS6040, "NS6040" },
        { PHFUNC_MOD_NS8040, "NS8040" },
        { PHFUNC_MOD_CHROMA, "CHROMA" },
        { PHFUNC_MOD_NS8000, "NS8000" },
