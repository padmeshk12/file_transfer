 ...
 *-----------------------------------------------------------------------------
 *
 * HISTORY  : 06 Sep 2000, Michael Vogt, created
 *            24 May 2006, Xiaofei Han,  added the definition for the MT99XX models
 *
 * Instructions:
 *
...
enum handlerModel
{
    ...
    PHFUNC_MOD_MT9510                   /* Multitest 9510 */,
    PHFUNC_MOD_MT93XX                   /* Multitest 93xx */,
    PHFUNC_MOD_MT99XX                   /* Multitest 99XX */,
    PHFUNC_MOD_INFLIP,                  /* Multitest InFlip strip handler*/
