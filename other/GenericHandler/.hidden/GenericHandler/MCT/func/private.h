...
#define STRIPMATERIALID_IMPLEMENTED
...
struct pluginPrivate {
    ...
    int             deviceExpected[PHESTATE_MAX_SITES];  /*some expected sites which normally has device*/
    int             devicePending[PHESTATE_MAX_SITES];
    int             oredDevicePending;
    int             deviceAvailable;                     /*device can be tested*/
    ...
    int             stripCalled;                         /*ph_strip_start is called*/
    int             stripSetPCCalled;                    /*true if we received SetPanelComplete in strip start process*/
    int             stripDone;                           /*true if "SetPanelComplete"message is received*/
};
