...
struct phFuncStruct
{
    ...
    const char               *cmodelName; /* configured model name */

    long                     heartbeatTimeout;

    int                      noOfSites;
    int                      activeSites[PHESTATE_MAX_SITES];
    int                      siteCategories[PHESTATE_MAX_SITES];
    const char               *siteIds[PHESTATE_MAX_SITES];
    
    int                      noOfBins;
    const char               **binIds;
    phBinMode_t              currentBinMode;
    struct transaction       *ta;

    enum handlerInterface    interfaceType;
    union
    {
