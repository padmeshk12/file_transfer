...
EventRecorder::EventRecorder(
        ...
        MiraeStatus *pMiraestatus           /* status object */,
        MiraeStatusObserver* recObs      /* observer object of status */,
    ...
    pHandController(pHC)
{
    ...
    pMiraestatus->registerRecorder(this,recObs);
}
...
EventPlayback::EventPlayback(
        phLogId_t l                       /* log identifier */,
        MiraeStatus *pMiraes            /* convert status str to enum
...
void EventPlayback::checkEvent(int eventCount)
{
    while ( eventCount >= recordStep && !end )
    {
        ...
        {
            bool eventUsed=pMiraestatus->setStatusBit(this, recordStatus, recordValue);
...
void EventPlayback::MiraeStatusChanged(MiraeStatus::eMiraeStatus, bool b)
{
}
...
void EventPlayback::getPlaybackComponent()
{
    ...
    if ( rtn_fscanf == 3 )
    {
        ...
        recordStatus=pMiraestatus->getEnumStatus(strRecordName);
