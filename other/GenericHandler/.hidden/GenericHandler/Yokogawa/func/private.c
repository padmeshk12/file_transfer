 ...
 *            02 Jan 2001, Chris Joyce modified for Yokogawa (Seiko-Epson-GPIB)
...
static phFuncError_t doReconfigure(phFuncId_t handlerID)
{
	...
	{
            phLogFuncMessage(handlerID->myLogger, PHLOG_TYPE_WARNING,
                    "remote stopping is not (yet) supported by Yokogawa handler");
	}
    }
