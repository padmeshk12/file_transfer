...
enum tempControl {
    PHFUNC_TEMP_MANUAL        /* not changed by the driver */,
    PHFUNC_TEMP_AMBIENT       /* set to ambient by driver */,
    PHFUNC_TEMP_ACTIVE        /* activated by driver */
};
...
struct tempSetup
{
    ...
    enum tempSwitch           control[PHFUNC_TEMP_MAX_CHAMBERS];
    /* do it or leave it for this chamber */
    ...
    enum tempSwitch           heat[PHFUNC_TEMP_MAX_CHAMBERS];    
    /* active heat flag */
    enum tempSwitch           cool[PHFUNC_TEMP_MAX_CHAMBERS];
    /* active cool flag */
};
