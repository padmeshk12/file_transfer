 ...
 *-----------------------------------------------------------------------------
 *
 * MODULE   : AdvantestViewController.h
 * CREATED  : 29 Apri 2014
 *
 * CONTENTS : Interface header for Advantest view controller implementation 
 *            class
 *
...
#ifndef _ADVANTEST_VIEW_CONT_IMPL_H_
#define _ADVANTEST_VIEW_CONT_IMPL_H_
...
#endif /* ! _ADVANTEST_VIEW_CONT_IMPL_H_ */
