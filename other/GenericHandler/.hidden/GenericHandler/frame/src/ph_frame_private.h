...
struct phFrameStruct
{
    ...
    phFuncAvailability_t           funcAvail;
    phHookAvailability_t           hookAvail;

    int                            numSites;
    long                           stToHandlerSiteMap[PHESTATE_MAX_SITES];

    phBinMode_t                    binMode;
    phBinMapId_t                   binMapHdl;

    long                           deviceBins[PHESTATE_MAX_SITES];
    phBinAction_t                  binAction;
    long                           devicePassed[PHESTATE_MAX_SITES];
    int                            dontTrustBinning;

    phReprobeMode_t                autoReprobe;
    long                           deviceToReprobe[PHESTATE_MAX_SITES];
